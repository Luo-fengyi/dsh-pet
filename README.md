...
> **关于代码是怎么来的**：整个项目——从 Live2D 渲染、DSH 状态联动、看屏幕，到设置窗，
> 以及那些你没看到的反复调试和踩坑——都是在 **DeepSeek Harness（DSH）** 里由
> **`deepseek-v4.1-flash`** 完成的，人只负责提需求、拍板和验收。
> 所以这是一份 AI 写出来的工程：主要功能都实测跑通过，但**大概率还藏着不少没被发现的 bug**。
> 用的时候请多留个心眼；遇到问题欢迎提 issue，能顺手指出哪儿不对就更好了。
